...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-brown navbar-dark shadow-lg fixed-top">
    ...
    <div class="col-md-4">
        ...
        <img src="../img-coffee/<?php echo $row['product_image']; ?>" class="card-image card-img-top img-fluid">
...
<?php endforeach; ?>
    ...
    <?php foreach($product as $row): ?>
    <!-- Modal -->
    <div class="modal fade" id="btnModal<?php echo $row['product_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <!-- Konten Modal -->
                ...
                <div class="modal-footer text-center">
                    <?php if(isset($_SESSION['login'])): ?>
                        <?php
                            ...
                            $cartUrl = 'add_to_cart.php?product_id=' . $productId . '&quantity=1'; // Default quantity di sini adalah 1
                        ?>
                        ...
                        <a href="<?php echo $cartUrl; ?>" class="btn-popup text-center text-decoration-none">Tambahkan Ke Keranjang</a>
                    <?php else: ?>
        ...
        <?php if (count($cart) > 0): ?>
            <?php foreach ($cart as $item): ?>
                <div class="cart-item mb-3">
                    ...
                    <div class="cart-quantity">Quantity: <?php echo $item['quantity']; ?></div>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
            <div class="text-center">Keranjang belanja kosong.</div>
        <?php endif; ?>
    </div>
</div>        
  <!-- About -->
